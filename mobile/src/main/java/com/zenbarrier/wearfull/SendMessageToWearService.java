...
public class SendMessageToWearService extends IntentService {

    private static final String EXTRA_PARAM = "path";
    private static final long TIME_OUT_MS = 100;
    private static final String TAG = SendMessageToWearService.class.getSimpleName();

    public SendMessageToWearService() {
        super("SendMessageToWearService");
    }

    public static void sendMessage(Context context, String path) {
        Intent intent = new Intent(context, SendMessageToWearService.class);
